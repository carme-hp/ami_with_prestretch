...
if ".py" in sys.argv[0]:
  ...
  if rank_no == 0:
    print("Warning: There is no variables file, e.g:\n ./muscle_precice ../settings_muscle_right.py variables.py\n")
  exit(0)
...
if rank_no == 0:
  ...
  print("firing_times_file:       {}".format(variables.no_firing_times_file))
  print("********************************************************************************")
...
k = 0 #fix tendon side of the muscle during prestretch
...
k = mz-1
variables.prestretch_elasticity_neumann_bc = [{"element": k*mx*my + j*mx + i, "constantVector": variables.prestretch_bottom_traction_right, "face": "2+"} for j in range(my) for i in range(mx)]
  ...
  "Coupling": {
    ...
    "Term1": {
      "HyperelasticitySolver": {
        ...
        "slotNames":                  ["m2ux", "m2uy", "m2uz"],  # slot names of the data connector slots, there are three slots, namely the displacement components ux, uy, uz
      ...
      "Coupling": {
                        ...
                        "instances": [
                          {
                            ...
                            "Heun" : {
                              ...
                              "inputMeshIsGlobal":            False,                                    # the boundary conditions and initial values would be given as global numbers
                        ...
                        "instances": [
                          {
                            ...
                            "ImplicitEuler": {
                              ...
                              "dirichletOutputFilename":     None,                                    # filename for a vtp file that contains the Dirichlet boundary condition nodes and their values, set to None to disable
                              "inputMeshIsGlobal":           False,                                    # initial values would be given as global numbers
        ...
        "Term2": {
          "MuscleContractionSolver": {
                ...
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.scenario_name + "/muscle2_contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
                ],
                ...
                "DynamicHyperelasticitySolver": {
                  ...
                  # mesh
                  "inputMeshIsGlobal":          False,                     # boundary conditions and initial values are given as global numbers (every process has all information)
                  "meshName":                   "muscle2Mesh_quadratic",       # name of the 3D mesh, it is defined under "Meshes" at the beginning of this config
                  ...
                  # 1. main output writer that writes output files using the quadratic elements function space. Writes displacements, velocities and PK2 stresses.
                  "OutputWriter" : [
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle2_displacements", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ...
                  "pressure": {   # output files for pressure function space (linear elements), contains pressure values, as well as displacements and velocities
                    "OutputWriter" : [
                      {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle2_pressure", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                    ]
                  },
                  ...
                  "dynamic": {    # output of the dynamic solver, has additional virtual work values
                    "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                      ...
                      {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle2_virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                    ],
                  },
                  # 4. output writer for debugging, outputs files after each load increment, the geometry is not changed but u and v are written
                  "LoadIncrements": {
